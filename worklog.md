...
1. **Patch the admin-password fallback** in `worker/src/index.js:849` to fail closed (return 503 if `ADMIN_PASSWORD` is unset) instead of falling back to the hardcoded `Avishkar@44332297768` that is publicly committed.
