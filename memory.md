...
+---------------+-------------------------+---------------------------------------------+-------------------------------+
| INC-2026-09G  | Turbopack Font Query    | Passing static weight array to variable font| Configured JetBrains_Mono with|
|               | Resolution Error on CI  | JetBrains_Mono crashed Turbopack replacer.  | subsets: ['latin'] as variable|
+---------------+-------------------------+---------------------------------------------+-------------------------------+
```
